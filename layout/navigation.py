...
def create_layout(lang_data):
    ...
    Toolbox_local = lang_data[LOCAL_TOOLBOX]
        ...
        [
            sg.Frame('', [
                [
                    ...
                    sg.Button(Settings_local,visible=True,k=SETTINGS_TAB_BTN,font=FONT,expand_x=True,size=(15,2),button_color=nav_tab_button_color,mouseover_colors=nav_tab_mouseover_colors),
                    sg.Button(Toolbox_local,visible=True,k=TOOLBOX_TAB_BTN,font=FONT,expand_x=True,size=(15,2),button_color=nav_tab_button_color,mouseover_colors=nav_tab_mouseover_colors),
